...
public class ReceitaDespesaManagedBean implements Serializable {
		...
		try {
			...
			FacesContext.getCurrentInstance().addMessage(
					...
					new FacesMessage(FacesMessage.SEVERITY_INFO, "Sucesso",
							despesaNova.getTitulo() + " cadastrada com sucesso!"));
	...
	public void editarDespesa(ActionEvent event) {
		LOG.info("editarDespesa");
		...
		try {
			...
			FacesContext.getCurrentInstance().addMessage(
					null,
					new FacesMessage(FacesMessage.SEVERITY_INFO, "Sucesso",
							receitaDespesaSelecionado.getTitulo() + " alterada com sucesso!"));
			carregarTabela(event);
			limparSessao();
		} catch (ClassNotFoundException e) {
			FacesContext.getCurrentInstance().addMessage(
	...
	public void excluirReceitaDespesa(ActionEvent event) {
		...
		try {
			...
			FacesContext.getCurrentInstance().addMessage(
					null,
					new FacesMessage(FacesMessage.SEVERITY_INFO, "Sucesso",
							receitaDespesaSelecionado.getTitulo() + " excluída com sucesso!"));
			carregarTabela(event);
			limparSessao();
		} catch (ClassNotFoundException e) {
			FacesContext.getCurrentInstance().addMessage(
